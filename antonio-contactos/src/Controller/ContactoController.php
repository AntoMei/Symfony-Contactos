...
class ContactoController extends AbstractController
{
    ...
    */
    ...
    public function insertarConProvincia(ManagerRegistry $doctrine): Response{
        ...
        $contacto->setEmail("insercio.de.prueba.provincia@contacto.es");
    ...
    public function insertarSinProvincia(ManagerRegistry $doctrine): Response{
        ...
        $contacto->setTelefono("900220022");
        $contacto->setEmail("insercio.de.prueba.sin.provincia@contacto.es");
        $contacto->setProvincia($provincia);
    ...
    public function insertar(ManagerRegistry $doctrine)
    {
        ...
        try
        {
            //Sólo se necesita realizar flush una vez y confirmará todas las opraciones pendientes
            $entityManager->flush();
    ...
    public function buscarOld($texto): Response{
        //Filtramos aquellos que contengan docho texto en el nombre
